...
fig.add_trace(go.Box(y=wallet1, showlegend=True, jitter=0.5, boxmean='sd', boxpoints='all', notched=False, marker_color="#ffaa00", name='Blue Chips'))

fig.add_trace(go.Box(y=wallet2, showlegend=True, jitter=0.5, boxmean='sd', boxpoints='all', notched=False, marker_color="#ae2012", name='Small Caps'))

fig.add_trace(go.Box(y=wallet3, showlegend=True, jitter=0.5, boxmean='sd', boxpoints='all', notched=False, marker_color="#283618", name='Mista'))
